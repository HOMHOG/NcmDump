...
int
process_file(const char *path, const char *exportPath) {
    uint32_t ulen = 0;
    int i;
    ...
    char *perfectexportPath = new char[1024];
    strcpy(perfectexportPath, exportPath);
    strcat(perfectexportPath, filter_music_filename);
    ...
    FILE *fmusic = fopen(perfectexportPath, "w+");
